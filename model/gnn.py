...
class HarfBipartiteNetwork(torch.nn.Module):
    ...
    def forward(self, batch, data):
        ...
        # right_x = torch.cat([right_x, right_x_bi2], dim=1)
        # left_x = torch.cat([left_x, left_x_bi2], dim=1)
        ...
        # features = torch.cat([bipartite_x_readout1, bipartite_x_readout2, left_x_readout1, left_x_readout2, right_x_readout1, right_x_readout2], dim=1)
...
class MLP(nn.Module):
    def __init__(self, input_size, hidden_size, hidden_size2, num_classes):
        ...
        # self.dropout1 = nn.Dropout(0.6)  # 补充实验
        # self.dropout2 = nn.Dropout(0.6)  # 补充实验
